...
DECLARE SUB LD2.FadeIn (delay AS DOUBLE)
DECLARE SUB LD2.FadeOut (delay AS DOUBLE)
...
DECLARE SUB LD2.fillm (x AS INTEGER, y AS INTEGER, w AS INTEGER, h AS INTEGER, col AS INTEGER, buffer AS INTEGER)
DECLARE SUB LD2.fillw (x AS INTEGER, y AS INTEGER, w AS INTEGER, h AS INTEGER, col AS INTEGER, buffer AS INTEGER)
